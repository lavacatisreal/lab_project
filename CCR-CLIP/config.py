config = {
    ...
    'imageW': 128,
    'imageH': 128,
    'alphabet_path': '/content/improve_FudanOCR/CCR-CLIP/data/radical_alphabet_27533_benchmark.txt',
    'decompose_path': '/content/improve_FudanOCR/CCR-CLIP/data/decompose_27533_benchmark.txt',
    'max_len': 30,
    'lr': 1e-4,
